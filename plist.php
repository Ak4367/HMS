...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4  fs-4 fw-bold text-uppercase border-bottom"> <a
                    class="navbar-brand text-bg-success text-dark" href="index.php"><img src="pics/logo1_edited.jpg"
                        width="50" height="50"><strong>CARE HOSPITAL</strong></a></div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/project/plist.php" method="post" class="row g-3">
                                <div class="col-md-4">
                                        <label for="ptype" class="form-label">Patient Type</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="admdate" class="form-control" id="admdate">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="admtime" class="form-label">Admission Time</label>
                                        <input type="time" name="admtime" class="form-control" id="admtime">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="pin" class="form-label">Pin Code</label>
                                        <input type="text" name="pin" class="form-control" id="pin">
                                    ...
                                    <div class="col-md-4">
                                        <label for="gender" class="form-label">Patient Type</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="status" class="form-label">Patient Type</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/project/edit.php" method="post">
                                    <input type="hidden" name="pedit" value="<?php echo $row['patientid'] ?>">
                                    <button type="submit" name="edit_btn" class="btn btn-success">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="/project/edit.php" method="post">
                                    <input type="hidden" name="pdel" value="<?php echo $row['patientid'] ?>">
