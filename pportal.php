...
$pno = mysqli_num_rows($p);
//For total number of doctors
$sql = "select * from doctor";
$d = mysqli_query($conn,$sql);
$dno = mysqli_num_rows($d);
echo '<!DOCTYPE html>
<html lang="en">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-dark py-4 px-4">
                <div class="d-flex align-items-center text-white">
                    ...
                    <h2 class="fs-2 m-0">Welcome '.$data['patientname'].'</h2>
                </div>
                    ...
                    <ul class="navbar-nav bg-white ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i>'.$data['pusername'].'
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="pprofile.php">Profile</a></li>
                                <li><a class="dropdown-item" href="#">Settings</a></li>
                                <li><a class="dropdown-item" href="plogout.php">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container-fluid bg-success px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">'.$pno.'</h3>
