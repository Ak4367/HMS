...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"> <a class="navbar-brand text-bg-success text-dark" href="index.php"><img src="pics/logo1_edited.jpg" width="50"
