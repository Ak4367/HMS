...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "select * from patient where pusername = '$username' AND password ='$password'";
...
?>
 <div class="card-body bg-dark text-white text-center">
    <h2 class="card-title">Welcome To Patient Portal</h2>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6">
        <img src="pics/pportal.jpg" alt="">
      </div>
      <div class="col-lg-6 bg-info text-dark">
     
        <form action ="/project/plogin.php" method="post">
  ...
  <div class="col">
    <div class="card">
      <img src="..." class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Quick Appointment</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="..." class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Access To Health Records</h5>
