...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $usertype = $_POST["type"];
  $sql = "select * from admin where username = '$username' AND  password ='$password' AND usertype = '$usertype'";
  ...
  if ($num == 1 && $usertype == "Admin")  {
  ...
  } elseif($num == 1 && $usertype == "Pharmacy manager") {
    $login = true;
    session_start();
    $_SESSION['loggedin'] = true;
    $_SESSION['username'] = $username;
    $_SESSION['password'] = $password;
    $_SESSION['usertype'] = $usertype;
    header("location: pharmacym.php");
  }
  elseif($num == 1 && $usertype == "Ward manager") {
    $login = true;
    session_start();
    $_SESSION['loggedin'] = true;
    $_SESSION['username'] = $username;
    $_SESSION['password'] = $password;
    $_SESSION['usertype'] = $usertype;
    header("location: wardm.php");
    
  }
  else{
    $error = "Invalid username/password OR Unauthorized Access";
  }
}
?>
<!doctype html>
...
<body>
  ...
  <div class="card-body bg-dark text-white text-center">
    <h2 class="card-title">Welcome To Administrator Login</h2>
  </div>
  <?php
  if ($error) {
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6">
        <img src="pics/admin_edited.jpg" alt="">
      </div>
        ...
        <form action="/project/Adminlogin.php" method="post">
          ...
          <div class="form-row py-3">
            <div class="col-md-6">
              ...
              <input type="password" placeholder="Enter Password" class="form-control" id="inputPassword"
                name="password">
            </div>
          </div>
          <div class="col-md-4">
            ...
            <select id="type" name="type" class="form-select">
              ...
              <option>Appointment manager</option>
          ...
          <div class="row py-3">
            ...
            <div class="col-lg-4 col-md-6 mb-lg-0">
              ...
              <p class="text-muted mb-4">Here , write the complete address of the Registered office address along
                with
                telephone number.</p>
              <ul class="list-inline md-4">

                <li class="list-inline-item"><a class="icon-link link-dark" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="" height="" fill="currentColor"
                      class="bi bi-facebook" style="font-size: 30px;" viewBox="0 0 16 16">
                      <path
                ...
                <li class="list-inline-item"><a class="icon-link link-dark" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-twitter" style="font-size: 30px;" viewBox="0 0 16 16">
                      <path
                ...
                <li class="list-inline-item"><a class="icon-link link-dark" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-instagram" style="font-size: 30px;" viewBox="0 0 16 16">
                      <path
                ...
                <li class="list-inline-item">
                  <a class="icon-link link-dark" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                      class="bi bi-youtube" style="font-size: 30px;" viewBox="0 0 16 16">
                      <path
            ...
            <div class="bg-light py-2">
              <div class="container text-center">
                <p class="text-muted mb-0 py-2">&copy; 2023 CARE HOSPITAL All rights reserved.</p>
